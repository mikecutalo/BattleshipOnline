...
//			if(((col + Game.currentShipSize-1) < 10 )&& 
//				this.board[row][col + (Game.currentShipSize-1)].isSpaceEmpty() == true)
//			{				
//				for(int i=1; i < (Game.currentShipSize-1); i++)
//				{	
//					this.board[row][col + i].setIcon(new ImageIcon(getClass().getResource("/images/missHit.jpg")));
//				}
//				
//				this.board[row][col + (Game.currentShipSize-1)].setIcon(Game.currShipPlaceImg);
//				
//				//this.board[row][col + (Game.currentShipSize-1)].setIcon(new ImageIcon(img));
//				//this.board[row][col + (Game.currentShipSize-1)].setIcon(null);
//				//this.board[row][col + (Game.currentShipSize-1)].setBackground(Color.BLUE);
//				//this.board[row][col + (Game.currentShipSize-1)].setBorder(null);				
//			}
//			
//			if(((col - (Game.currentShipSize-1)) >= 0)&&
//				this.board[row][col - (Game.currentShipSize-1)].isSpaceEmpty() == true)
//			{
//				for(int i=1; i < (Game.currentShipSize-1); i++)
//				{
...
//			}
//			
//			if(((row + Game.currentShipSize-1) < 10)&&
//				this.board[row + (Game.currentShipSize-1)][col].isSpaceEmpty() == true)
//			{
//				for(int i=1; i < (Game.currentShipSize-1); i++)
//				{
//					this.board[row + i][col].setIcon(new ImageIcon(getClass().getResource("/images/missHit.jpg")));
//				}
//				this.board[row + (Game.currentShipSize-1)][col].setIcon(Game.currShipPlaceImg);
//				//this.board[row + (Game.currentShipSize-1)][col].setIcon(new ImageIcon(img));
//			}
//			
//			if(((row - (Game.currentShipSize-1)) >= 0)&&
//				this.board[row - (Game.currentShipSize-1)][col].isSpaceEmpty() == true)
//			{
//				for(int i=1; i < (Game.currentShipSize-1); i++)
//				{
...
//			}
		...
		else
		{
			...
			//thats where were putting the ship so dont DELETE IT!

//			if(secondCol != (col + (Game.currentShipSize-1)) &&
//			  (col + Game.currentShipSize-1) < 10 &&
//			  this.board[row][col + (Game.currentShipSize-1)].isSpaceEmpty() == true)
//			{
//				for(int i=1; i <= (Game.currentShipSize-1); i++)
//				{
...
//			if(secondRow != (row + (Game.currentShipSize-1)) &&
//			  (row + Game.currentShipSize-1) < 10 &&
//			  this.board[row + (Game.currentShipSize-1)][col].isSpaceEmpty() == true)
//			{
//				for(int i=1; i <= (Game.currentShipSize-1); i++)
//				{
